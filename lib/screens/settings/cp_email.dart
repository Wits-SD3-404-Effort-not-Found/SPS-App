...
class ChangePasswordEmailPage extends StatefulWidget {
  ...
  @override
  State<ChangePasswordEmailPage> createState() => _ChangePasswordEmailPage();
}

class _ChangePasswordEmailPage extends State<ChangePasswordEmailPage> {
